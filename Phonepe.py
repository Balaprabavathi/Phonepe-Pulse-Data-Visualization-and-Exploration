...
#1st take the Aggregrated insurance table
...
def Aggre_Tran_Transaction_type(df, state):
    ...
    with col1:
        fig_pie_1= px.pie(data_frame= tacyg, names= "Transaction_type", values= "Transaction_amount",
                                    width= 600, title= f"{state.upper()} TRANSACTION AMOUNT", hole= 0.5)  #hole means inner circle radius 50% of the circle
...
#Data Exploration menu
    ...
    with tab1:
        method = st.radio("Select The Method", ["Insurance Analysis", "Transactional Analysis", "User Analysis"])
